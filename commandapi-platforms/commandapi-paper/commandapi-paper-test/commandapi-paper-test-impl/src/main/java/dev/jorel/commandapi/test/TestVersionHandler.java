 ...
 * within the commandapi-paper-test-impl module is NOT used at run time. Instead, the
...
public abstract class TestVersionHandler {
	...
	public static MockPlatform getMockPlatform() {
		throw new IllegalStateException("Wrong version of TestVersionHandler loaded! " +
			"Make sure you are using commandapi-paper-test-impl-[version] instead of commandapi-paper-test-impl");
	}
}
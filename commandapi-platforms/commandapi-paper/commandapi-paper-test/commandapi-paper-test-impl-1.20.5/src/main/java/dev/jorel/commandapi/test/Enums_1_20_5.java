...
public interface Enums_1_20_5 extends Enums {
	@Override
	default Enchantment[] getEnchantments() {
	...
	@Override
	default EntityType[] getEntityTypes() {
	...
	@Override
	default LootTables[] getLootTables() {
		return new LootTables[]{
			...
			LootTables.TRIAL_CHAMBERS_REWARD_COMMON,
			LootTables.TRIAL_CHAMBERS_REWARD_RARE,
			LootTables.TRIAL_CHAMBERS_REWARD_UNIQUE,
			LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS,
			LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_COMMON,
			LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_RARE,
			LootTables.TRIAL_CHAMBERS_REWARD_OMINOUS_UNIQUE,
			LootTables.TRIAL_CHAMBERS_SUPPLY,
			LootTables.TRIAL_CHAMBERS_CORRIDOR,
			LootTables.TRIAL_CHAMBERS_INTERSECTION,
			LootTables.TRIAL_CHAMBERS_INTERSECTION_BARREL,
			LootTables.TRIAL_CHAMBERS_ENTRANCE,
			...
			LootTables.EQUIPMENT_TRIAL_CHAMBER,
			LootTables.EQUIPMENT_TRIAL_CHAMBER_RANGED,
			LootTables.EQUIPMENT_TRIAL_CHAMBER_MELEE,
			...
			LootTables.ARMOR_STAND,
			LootTables.AXOLOTL,
			LootTables.BAT,
			LootTables.BEE,
			LootTables.BLAZE,
			LootTables.CAT,
			LootTables.CAVE_SPIDER,
			LootTables.CHICKEN,
			LootTables.COD,
			LootTables.COW,
			LootTables.CREEPER,
			...
			LootTables.GHAST,
			LootTables.GIANT,
			LootTables.GLOW_SQUID,
			LootTables.GOAT,
			LootTables.GUARDIAN,
			LootTables.HOGLIN,
			LootTables.HORSE,
			LootTables.HUSK,
			LootTables.ILLUSIONER,
			LootTables.IRON_GOLEM,
			LootTables.LLAMA,
			LootTables.MAGMA_CUBE,
			LootTables.MOOSHROOM,
			LootTables.MULE,
			LootTables.OCELOT,
			LootTables.PANDA,
			LootTables.PARROT,
			...
			LootTables.PIG,
			LootTables.PIGLIN,
			LootTables.PIGLIN_BRUTE,
			LootTables.PILLAGER,
			LootTables.PLAYER,
			LootTables.POLAR_BEAR,
			LootTables.PUFFERFISH,
			LootTables.RABBIT,
			LootTables.RAVAGER,
			LootTables.SALMON,
			LootTables.SHULKER,
			LootTables.SILVERFISH,
			LootTables.SKELETON,
			LootTables.SKELETON_HORSE,
			LootTables.SLIME,
			...
			LootTables.STRAY,
			LootTables.STRIDER,
			LootTables.TRADER_LLAMA,
			LootTables.TROPICAL_FISH,
			LootTables.TURTLE,
			LootTables.VEX,
			LootTables.VILLAGER,
			LootTables.VINDICATOR,
			LootTables.WANDERING_TRADER,
			LootTables.WITCH,
			LootTables.WITHER,
			LootTables.WITHER_SKELETON,
			LootTables.WOLF,
			LootTables.ZOGLIN,
			LootTables.ZOMBIE,
			LootTables.ZOMBIE_HORSE,
			LootTables.ZOMBIE_VILLAGER,
			...
			LootTables.PANDA_SNEEZE,
			LootTables.PIGLIN_BARTERING,
			LootTables.TRIAL_CHAMBER_KEY,
			LootTables.TRIAL_CHAMBER_CONSUMABLES,
			LootTables.OMINOUS_TRIAL_CHAMBER_KEY,
			LootTables.OMINOUS_TRIAL_CHAMBER_CONSUMABLES,
			LootTables.TRIAL_CHAMBER_ITEMS_TO_DROP_WHEN_OMINOUS,
			LootTables.SHEARING_BOGGED,
	...
	@Override
	default PotionEffectType[] getPotionEffects() {

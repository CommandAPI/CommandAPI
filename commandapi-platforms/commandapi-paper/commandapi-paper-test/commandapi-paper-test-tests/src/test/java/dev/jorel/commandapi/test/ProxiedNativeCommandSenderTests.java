...
class ProxiedNativeCommandSenderTests extends TestBase {
	...
	void testSettingCaller() {
		...
		Player caller = getServer().setupMockedCraftPlayer();
	...
	void testSettingCallee() {
		Player caller = getServer().setupMockedCraftPlayer("caller");
		Player callee = getServer().setupMockedCraftPlayer("callee");
	...
	void testSettingLocation() {
		...
		World world = getServer().setupMockedCraftPlayer().getWorld();

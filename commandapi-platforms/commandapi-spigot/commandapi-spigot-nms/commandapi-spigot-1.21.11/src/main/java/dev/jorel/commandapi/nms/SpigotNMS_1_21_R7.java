...
public class SpigotNMS_1_21_R7 extends CommandAPISpigot<CommandSourceStack> {

	private static final CommandBuildContext COMMAND_BUILD_CONTEXT;

	private NMS_1_21_R7 bukkitNMS;
	...
	public SpigotNMS_1_21_R7(InternalSpigotConfig config) {
		super(config);
	}
